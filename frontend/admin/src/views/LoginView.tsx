      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-surface-container-lowest rounded-3xl border border-outline-variant/30 p-8 shadow-sm animate-fade-in-up">
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-3 py-2.5 px-4 rounded-xl border border-outline-variant/40 bg-surface-container-low text-on-surface text-sm font-semibold hover:bg-surface-container transition-colors disabled:opacity-50"
          >
            {/* Google Icon */}
          ...
          <div className="relative flex items-center gap-3 my-1">
            ...
            <span className="text-[11px] font-medium text-on-surface-variant">atau masuk dengan email</span>
            <div className="flex-1 h-px bg-outline-variant/25" />
          </div>
